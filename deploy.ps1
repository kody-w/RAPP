...
$RappRestoredTarget = "deploy.ps1"
$RappRestoredSourceCommit = "4f6c14bbdf5b2d43887a9c7ab9cbda8c075f0dd6"
$RappRestoredSourceBlob = "4576b46aa246ea5ec50deed70af824b5928fd7f6"
...
$RappGateArgs = @()
foreach ($boundValue in @($ResourceGroup, $Location, $OpenAILocation)) {
    if ($boundValue) {
        $RappGateArgs += [string]$boundValue
    }
}
$RappGateArgs += @($args)
