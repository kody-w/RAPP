...
# RAPP_RESTORED_SOURCE_COMMIT=844f84ef54ce2481f670a9ca8830c96a60b70c72
# RAPP_RESTORED_SOURCE_BLOB=0b779c2dad2ce0d5edf4d8e626e863b1a9d6d159
# RAPP_RESTORED_TARGET=rapp_brainstem/start.ps1
[Console]::Error.WriteLine(
    '{"schema":"rapp-restored-distribution-source/1.0",' +
    '"target":"rapp_brainstem/start.ps1","mode":"inspect",' +
    '"source_commit":"844f84ef54ce2481f670a9ca8830c96a60b70c72",' +
    '"source_blob":"0b779c2dad2ce0d5edf4d8e626e863b1a9d6d159",' +
...
foreach ($processArgument in [Environment]::GetCommandLineArgs()) {
    if ($processArgument -ieq "-File") {
        $RappStandaloneProcess = $true
    }
}
if ($RappStandaloneProcess) {
    exit 78
}
