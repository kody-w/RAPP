    ...
    try:
        ...
        if TWIN_MODE:
            system_content += (
                ...
                "work well.\n\n"
                "**EVERY TWIN SURFACE IS A CALIBRATION OPPORTUNITY.** The twin exists to "
                "build fidelity with the user — each turn is a chance to predict something "
                "about the user and let the user validate or contradict that prediction. "
                "That feedback is what grows the twin's accuracy over time. Do NOT waste "
                "twin surfaces on generic help prompts ('what can you do?', 'how do I "
                "deploy?', 'browse my agents'). Generic help is what the main assistant "
                "reply is for. The twin's job is different.\n\n"
                "CALIBRATION-SHAPED ACTIONS (the right pattern):\n"
                ...
                "Each action is the twin's bet, phrased so a click = 'yes, you're right about "
                "me' and ignoring it = signal in the other direction. The label IS the bet.\n\n"
                "HELP-SHAPED ACTIONS (avoid these — they build no fidelity):\n"
