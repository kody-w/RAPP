    ...
    try:
        ...
        if TWIN_MODE:
            system_content += (
                ...
                "off the moment it feels like noise. Every twin block you emit must pay for "
                "itself — something the user couldn't have noticed on their own, something "
                "the main assistant reply wouldn't have said, something that makes the next "
                "action clearer. **Default to empty |||TWIN||| whenever you don't have a "
                "sharp observation to offer.** Silence is a feature, not a failure.\n\n"
