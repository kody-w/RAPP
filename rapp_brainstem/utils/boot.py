...
# RAPP_RESTORED_SOURCE_COMMIT=7f9553ed0f079fbce70755ee4cae3e51705dcccf
# RAPP_RESTORED_SOURCE_BLOB=71d551da85bca64951ac6de1b5ae386b62402154
# RAPP_RESTORED_TARGET=rapp_brainstem/utils/boot.py
def _rapp_restored_refuse():
    stderr = __import__("sys").stderr
    print(
        '{"schema":"rapp-restored-distribution-source/1.0",'
        '"target":"rapp_brainstem/utils/boot.py","mode":"inspect",'
        '"source_commit":"7f9553ed0f079fbce70755ee4cae3e51705dcccf",'
        '"source_blob":"71d551da85bca64951ac6de1b5ae386b62402154",'
...
_rapp_restored_historical_main = main
main = _rapp_restored_refuse
# RAPP_RESTORED_IMPORT_OVERRIDE_END
