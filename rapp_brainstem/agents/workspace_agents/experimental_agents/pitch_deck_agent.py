    ...
    return {
        ...
        "why": {
            ...
            "pillars": [
                ...
                {"icon": "📦", "strong": "Shareable by design.", "rest": "Install with a file drop. Export your entire setup as a single .egg — agents, memories, soul — and restore it on any device."},
        ...
        "email": {
            ...
            "bullets": [
                ...
                {"strong": "Shareable by design.", "rest": "Agents install with a file drop. Your whole setup exports as a single .egg that works on any device."},
        ...
        "video": {
            "beats": [
                ...
                {"time": "2:00 – 2:30 · The portability", "body": '"Export .egg. One file — agents, memories, groups, everything. Drop it on a phone, a colleague\'s laptop, a fresh install. It resumes."'},
                {"time": "2:30 – 3:00 · The punchline", "body": '"Your AI setup travels with you. Laptop to phone to a teammate\'s machine. One file, zero configuration. That\'s the idea."'},
            ],
        ...
        "closer": {
            ...
            "flow_steps": [
                {"emoji": "📤", "name": "Export .egg", "role": "Your brainstem"},
                {"emoji": "💬", "name": "Share", "role": "Teams, AirDrop, email"},
                {"emoji": "🌐", "name": "Any Brainstem", "role": "Desktop, phone, browser"},
                {"emoji": "🧠", "name": "Running", "role": "Exactly where you left off", "color": "green"},
            ],
            "play_bullets": [
                {"strong": "Export .egg", "rest": "one click packs your entire brainstem — agents, memories, soul, groups — into a single portable file."},
                {"strong": "Share it", "rest": "post to Teams, AirDrop to your phone, email to a colleague. One file carries everything."},
                {"strong": "They drop it in", "rest": "any brainstem — laptop, phone browser, fresh install — imports the .egg and lights up with your full setup."},
                {"strong": "It just resumes", "rest": "same agents, same context, same groups. No configuration, no setup. The state travels with the person."},
            ],
            "punchline": '"I exported my brainstem on my laptop, dropped the .egg on my phone, and kept working. That\'s what portable AI should feel like."',
        },
