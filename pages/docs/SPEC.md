...
- **Workshop** — a folder of `*_agent.py` files under
  ...
  the hotload loop.
  > **Note (2026-09-24):** the Brainstem hot-loads only the top-level `agents/*_agent.py` files, so a workshop folder is organization only and its files are not hot-loaded. To try a workshop agent, move it to the top of `agents/`; move it back into a folder to unload it. See `CONSTITUTION.md` Article XVII (2026-09-24 amendment) and `docs/proposals/0001-only-top-level-agents-are-live.md`.
