...
- ◐ [[Platform Backlog]] — Now / Next / Later for engineering, design, infra, tooling
...
Reference notes — start here if you're new.
...
Curated routes through the vault by audience.

- ● [[Reading Path — Engineer Evaluating RAPP]] — 8 notes, ~30 min
- ● [[Reading Path — Architect Deciding to Bet]] — 6 notes, ~25 min
- ● [[Reading Path — Partner Pricing a Project]] — 5 notes, ~15 min
- ● [[Reading Path — Exec Asking What This Is]] — 3 notes, ~7 min
- ● [[Reading Path — New Contributor]] — 7 notes + the constitution
