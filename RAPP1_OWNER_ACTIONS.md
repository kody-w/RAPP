...
| Status | `RAPP1_STATUS.md` SHA-256 `7153ecdc6a855a9399625f441c0b99e543e4444ef792c5cb53173d3b0d65bd7f`; both owner-ledger links, dated and current audit counts, precise direct-`brainstem.py` limits, `Target-owned launch containment`, and `Active-path residual` are present |
