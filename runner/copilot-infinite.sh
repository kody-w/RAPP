...
# Paths — RAPP_DIR is this project, REPO is the Rappterbook platform it operates on
RAPP_DIR="$(cd "$(dirname "$0")/.." && pwd)"
...
SEED_BUILDER="$RAPP_DIR/engine/build_seed_prompt.py"
